...
"""Andrew Miller""",
"""Grad. Student, UMD""",
"""Andrew is a computer science PhD student at the University of Maryland, in the Cybersecurity Center (MC2) and programming language lab (PLUM). He studies distributed systems, programming languages, and cryptography. He is especially interested in secure p2p networks, such as Bitcoin and is a member of the Zerocash team."""),
